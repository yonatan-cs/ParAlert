...
export const STRINGS = {
  he: {
    ...
    card: {
      ...
      reveal: "הצג בכל זאת",
      video: "וידאו",
      evidenceTitle: "הוכחות לשיחה",
      evidenceNote: "צילום מסך של השיחה לצירוף לתלונה במשטרה.",
      evidenceDownload: "הורד צילומי מסך",
      evidenceFooter: "הופק ע\"י ParAlert",
    },
    category: {
      harassment: "הטרדה",
      threat: "איום",
    ...
    tryit: {
      ...
      verdictDeepfake: "זוהה דיפפייק / תוכן שנוצר ב-AI",
      toxicity: "מדד רעילות",
  ...
  en: {
    ...
    card: {
      ...
      reveal: "Show anyway",
      video: "video",
      evidenceTitle: "Conversation evidence",
      evidenceNote: "Screenshot of the conversation to attach to a police report.",
      evidenceDownload: "Download screenshots",
      evidenceFooter: "Generated by ParAlert",
    },
    category: {
    ...
    tryit: {
      ...
      verdictDeepfake: "Deepfake / AI-generated detected",
      toxicity: "Toxicity",
